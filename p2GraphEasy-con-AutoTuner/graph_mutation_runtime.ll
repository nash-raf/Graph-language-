...
35:                                               ; preds = %29
  ...
  %37 = load i64, ptr %0, align 8, !tbaa !3
...
88:                                               ; preds = %84
  ...
  br i1 %90, label %94, label %79, !llvm.loop !16
...
42:                                               ; preds = %36, %33
  ...
  store i32 %3, ptr %44, align 4, !tbaa !14
...
49:                                               ; preds = %44
  ...
  br i1 %51, label %80, label %44, !llvm.loop !20
...
60:                                               ; preds = %55
  ...
  %65 = load i64, ptr %0, align 8, !tbaa !3
...
67:                                               ; preds = %60, %55
  ...
  %70 = add nsw i64 %57, -1
  store i64 %70, ptr %56, align 8, !tbaa !18
...
72:                                               ; preds = %67, %72
  ...
  br i1 %79, label %72, label %83, !llvm.loop !21
...
89:                                               ; preds = %83
  ...
  %91 = load i64, ptr %0, align 8, !tbaa !3
...
104:                                              ; preds = %99
  ...
  br i1 %106, label %200, label %99, !llvm.loop !20
...
115:                                              ; preds = %110
  ...
  %120 = load i64, ptr %0, align 8, !tbaa !3
  br label %121

121:                                              ; preds = %115, %110
  %122 = phi i64 [ %120, %115 ], [ %91, %110 ]
  %123 = add nsw i64 %112, -1
  store i64 %123, ptr %111, align 8, !tbaa !18
  %124 = icmp sgt i64 %122, %90
  br i1 %124, label %125, label %200

125:                                              ; preds = %121
  %126 = load ptr, ptr %25, align 8, !tbaa !11
  br label %127
...
127:                                              ; preds = %127, %125
  ...
  %133 = load i64, ptr %0, align 8, !tbaa !3
  %134 = icmp slt i64 %129, %133
  br i1 %134, label %127, label %200, !llvm.loop !21
...
145:                                              ; preds = %139
  ...
  %147 = load i64, ptr %0, align 8, !tbaa !3
...
165:                                              ; preds = %160
  ...
  store i32 -1, ptr %166, align 4, !tbaa !14
  br label %170
...
192:                                              ; preds = %187
  ...
  store i32 -1, ptr %193, align 4, !tbaa !14
  br label %200

194:                                              ; preds = %187
  %195 = add i64 %188, 1
  %196 = icmp eq i64 %195, %185
  br i1 %196, label %200, label %187, !llvm.loop !22
