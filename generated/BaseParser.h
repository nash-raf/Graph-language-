...
public:
  enum {
    ...
    T__32 = 33, T__33 = 34, T__34 = 35, GRAPH = 36, EDGE = 37, NODE = 38, 
    OF = 39, PLUS = 40, MINUS = 41, TIMES = 42, DIVIDE = 43, AND = 44, OR = 45, 
    EQUAL = 46, NOTEQUAL = 47, LESSTHAN = 48, GREATERTHAN = 49, LESSEQUAL = 50, 
    GREATEREQUAL = 51, ID = 52, INT = 53, STRING = 54, Comment = 55, WS = 56
  };
  ...
  enum {
    ...
    RuleLoopTarget = 18, RuleWhileStatement = 19, RuleQueryStatement = 20, 
    RuleShowgraph = 21, RuleFunction = 22, RuleReturnType = 23, RuleParamList = 24, 
    RuleParam = 25, RuleType = 26, RuleFunctionCall = 27, RuleArgumentList = 28, 
    RuleBlock = 29, RuleReturnStatement = 30, RulePrintStatement = 31, RulePrintExpr = 32, 
    RulePrintgraph = 33, RuleExpr = 34
  };
