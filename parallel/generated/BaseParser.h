...
public:
  enum {
    ...
    SET = 45, UNION = 46, INTERSECT = 47, EDGE = 48, NODE = 49, TRUE = 50, 
  ...
  enum {
    ...
    RuleSetExpr = 16, RuleSetMethodCall = 17, RuleGraphComprehension = 18, 
    RuleGraphCondition = 19, RuleConditionalStatement = 20, RuleCondition = 21, 
    RuleLoopStatement = 22, RuleForeachStatement = 23, RuleLoopTarget = 24, 
    RuleWhileStatement = 25, RuleNodeEdgeOperation = 26, RuleAddOperation = 27, 
    RuleRemoveOperation = 28, RuleAddTargets = 29, RuleRemoveTargets = 30, 
    RuleQueryStatement = 31, RuleShowgraph = 32, RuleFunction = 33, RuleReturnType = 34, 
    RuleParamList = 35, RuleParam = 36, RuleType = 37, RuleFunctionCall = 38, 
    RuleArgumentList = 39, RuleBlock = 40, RuleReturnStatement = 41, RulePrintStatement = 42, 
    RulePrintExpr = 43, RulePrintgraph = 44, RuleExpr = 45, RuleArrayDeclarator = 46, 
    RuleArrayInitializer = 47, RuleAssignmentStatement = 48, RuleArrayAssignStatement = 49
  };
  ...
  class  BooleanExprContext : public ConditionContext {
  public:
    BooleanExprContext(ConditionContext *ctx);
