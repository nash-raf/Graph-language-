...
graph_template = """graph g {{
    ...
    edges: file '../synth_graphs_violin/synth_v_{v}_e_{e}_seed_{s}.txt';
...
def run_experiment(algo, v, e, s):
    ...
    test_graph_content = graph_template.format(v=v, e=e, algo=algo, s=s)  # Using seed=1 for simplicity
    ...
    log_filename = f"../log/{algo}_p2grapheasy_synth_v_{v}_e_{e}_seed_{s}.txt"
